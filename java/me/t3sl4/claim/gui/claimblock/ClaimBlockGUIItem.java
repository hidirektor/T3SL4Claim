...
public class ClaimBlockGUIItem {
    public static List<ClaimBlockGUIItem> claimBlockGUIItems = new ArrayList<>();
    ...
    public ClaimBlockGUIItem(FileConfiguration fc, String selected, FileConfiguration fc2) {
